...
import sf.l2j.loginserver.network.serverpackets.PlayOk;

/**
 * <p>
 * This class is used to represent session keys used by the client to
 * authenticate in the gameserver
 * </p>
 * <p>
 * A SessionKey is made up of two 8 bytes keys. One is send in the
 * {@link LoginOk LoginOk} packet
 * and the other is sent in
 * {@link PlayOk PlayOk}
 * </p>
 */
