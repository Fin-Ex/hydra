...
import ru.finex.transport.hydra.service.auth.AuthSessionService;
import ru.finex.transport.hydra.service.world.WorldSessionService;
...
@Slf4j
@Singleton
@ClusteredService("server-${config['ru.finex.ws.hydra.service.SessionService.serverId']}")
