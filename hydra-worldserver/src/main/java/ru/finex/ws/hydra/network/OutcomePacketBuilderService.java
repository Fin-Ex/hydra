...
import ru.finex.ws.hydra.network.model.dto.AllFortressInfoDto;
import ru.finex.ws.hydra.network.model.dto.AuthLoginFailDto;
import ru.finex.ws.hydra.network.model.dto.ChangeMoveTypeDto;
import ru.finex.ws.hydra.network.model.dto.CharacterCreateFailDto;
...
import ru.finex.ws.hydra.network.model.dto.Ex2ndPasswordCheckDto;
import ru.finex.ws.hydra.network.model.dto.IsCharacterNameCreatableDto;
import ru.finex.ws.hydra.network.model.dto.LeaveWorldDto;
import ru.finex.ws.hydra.network.model.dto.ManorListDto;
import ru.finex.ws.hydra.network.model.dto.MoveToLocationDto;
import ru.finex.ws.hydra.network.model.dto.NewCharacterSuccessDto;
...
import ru.finex.ws.hydra.network.model.dto.VersionCheckDto;
...
public class OutcomePacketBuilderService {
    ...
    @ConfigResource(basePath = "ru.finex.ws.hydra.service.SessionService")
