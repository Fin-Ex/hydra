...
import ru.finex.ws.hydra.network.codec.LengthFieldBasedFrameEncoder;
import ru.finex.ws.hydra.network.codec.LogDecoder;
import ru.finex.ws.hydra.network.codec.LogEncoder;
import ru.finex.ws.hydra.network.codec.LogHexDecoder;
import ru.finex.ws.hydra.network.codec.LogLengthDecoder;
...
public class NetworkPipeline extends AbstractNetworkPipeline {
    ...
    private static final int MAX_PACKET_SIZE = 64 * 1024 - 2;
