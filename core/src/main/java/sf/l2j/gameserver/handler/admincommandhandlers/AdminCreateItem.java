...
import sf.l2j.gameserver.model.item.ArmorSet;
 ...
 * - create_item = creates num items with respective id, if num is not
 * specified, assumes 1.<br>
 * - create_set = creates armorset with respective chest id.<br>
 * - create_coin = creates currency, using the choice box or typing good
 * IDs.<br>
