 ...
 * <li>cw_remove : removes a cursed weapon from the world - item id or name must
 * be provided.</li>
 * <li>cw_add : adds a cursed weapon into the world - item id or name must be
 * provided. Current target will be the owner.</li>
 * <li>cw_goto : teleports GM to the specified cursed weapon (item or player
 * position).</li>
