package sf.l2j.gameserver.handler.admincommandhandlers;


import java.util.StringTokenizer;
import sf.l2j.gameserver.data.SkillTable;
import sf.l2j.gameserver.handler.IAdminCommandHandler;
...
import sf.l2j.gameserver.network.serverpackets.SunRise;
import sf.l2j.gameserver.network.serverpackets.SunSet;
 ...
 * <li>earthquake = causes an earthquake of a given intensity and duration
 * around you.</li>
 ...
 * <li>social = forces an Creature instance to broadcast social action
 * packets.</li>
	...
	public boolean useAdminCommand(String command, Player activeChar) {
		...
		if (command.startsWith("admin_hide")) {
			...
			try {
				...
				if (val > 0 && val < 5) {
					activeChar.doCast(SkillTable.getInstance().getInfo(7029, val), false);
				}
			} catch (Exception e) {
