...
import sf.l2j.gameserver.network.serverpackets.AskJoinParty;
...
public final class RequestJoinParty extends L2GameClientPacket {
	...
	protected void runImpl() {
		...
		if (target.equals(requestor) || target.isCursedWeaponEquipped() || requestor.isCursedWeaponEquipped() || target.getAppearance().isInvisible()) {
		...
		if (party != null) {
			...
			requestor.setLootRule(EPartyLoot.VALUES[_itemDistribution]);
		}
