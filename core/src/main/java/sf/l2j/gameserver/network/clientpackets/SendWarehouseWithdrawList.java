...
import sf.l2j.gameserver.network.serverpackets.EnchantResult;
	...
	protected void runImpl() {
		...
		for (IntIntHolder i : _items) {
			...
			if (oldItem == null || oldItem.getCount() < i.getValue()) {
				_log.warn("Error withdrawing a warehouse object for " + player.getName() + " (olditem == null)");
				return;
			}
			...
			if (newItem == null) {
				_log.warn("Error withdrawing a warehouse object for " + player.getName() + " (newitem == null)");
				return;
			}
