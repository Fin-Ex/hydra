...
import sf.l2j.gameserver.model.L2Macro.L2MacroCmd;
...
public final class RequestMakeMacro extends L2GameClientPacket {
	...
	/**
	 * packet type id 0xc1 sample c1 d // id S // macro name S // unknown desc S
	 * // unknown acronym c // icon c // count c // entry c // type d // skill
	 * id c // shortcut id S // command name format: cdSSScc (ccdcS)
	 */
	@Override
