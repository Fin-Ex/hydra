...
import sf.l2j.gameserver.handler.chathandlers.ChatAll;
import sf.l2j.gameserver.handler.chathandlers.ChatAlliance;
import sf.l2j.gameserver.handler.chathandlers.ChatClan;
import sf.l2j.gameserver.handler.chathandlers.ChatHeroVoice;
import sf.l2j.gameserver.handler.chathandlers.ChatParty;
import sf.l2j.gameserver.handler.chathandlers.ChatPartyMatchRoom;
import sf.l2j.gameserver.handler.chathandlers.ChatPartyRoomAll;
import sf.l2j.gameserver.handler.chathandlers.ChatPartyRoomCommander;
import sf.l2j.gameserver.handler.chathandlers.ChatPetition;
import sf.l2j.gameserver.handler.chathandlers.ChatShout;
import sf.l2j.gameserver.handler.chathandlers.ChatTell;
import sf.l2j.gameserver.handler.chathandlers.ChatTrade;
