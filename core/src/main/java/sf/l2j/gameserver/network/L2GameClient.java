...
import ru.finex.gs.network.ServicePacketExecutor;
...
public final class L2GameClient extends MMOClient<MMOConnection<L2GameClient>> {
	...
	@Inject @Getter
	private ServicePacketExecutor servicePacketExecutor;
	...
	/**
	 * Close client connection with {@link OutcomePacketBuilderService#serverClose()} packet
	 */
	public void closeNow() {
		isDetached = true; // prevents more packets execution
		close(packetBuilderService.serverClose());
	}
