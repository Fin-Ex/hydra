...
import sf.l2j.gameserver.model.actor.instance.FeedableBeast;
 ...
 * Manager for CWs.
 * <ul>
 * <li><u>dropRate :</u> the drop rate used to monster drop the CW. Default :
 * 1/1000000</li>
 * <li><u>duration :</u> the overall lifetime duration in hours. Default : 72
 * hours (3 days)</li>
 * <li><u>durationLost :</u> the task time duration, launched when someone
 * pickups a CW. Renewed when CW owner kills a player. Default : 24 hours.</li>
 * <li><u>disapearChance :</u> chance to dissapear when CW owner dies. Default :
 * 50%</li>
 * <li><u>stageKills :</u> the basic number used to calculate random needed
 * number of needed kills to rank up the CW. That number is used as a base, it
 * takes a random number between 50% and 150% of that value. Default : 10</li>
 * </ul>
 *
...
public class CursedWeaponsManager {
	...
	/**
	 * Checks if a CW can drop. Verify if CW is already active, or if the
	 * L2Attackable you killed was a good type.
	 *
	...
	/**
	 * Assimilate a weapon if you already possess one (and rank up possessed
	 * weapon), or activate it otherwise.
	 *
	...
	/**
	 * This method is used on EnterWorld in order to check if the player is
	 * equipped with a CW.
	 *
	 * @param player
	 */
