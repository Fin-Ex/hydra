...
import sf.l2j.gameserver.instancemanager.AutoSpawnManager.AutoSpawnInstance;
import sf.l2j.gameserver.model.World;
import sf.l2j.gameserver.model.actor.Player;
import sf.l2j.gameserver.network.SystemMessageId;
import sf.l2j.gameserver.network.serverpackets.SSQInfo;
...
public class SevenSigns {
	...
	/**
	 * Registers all random spawns and auto-chats for Seven Signs NPCs, along
	 * with spawns for the Preachers of Doom and Orators of Revelations at the
	 * beginning of the Seal Validation period.
	 */
	...
	/**
	 * Restores all Seven Signs data and settings, usually called at server
	 * startup.
	 */
	...
	/**
	 * Used to reset the cabal details of all players, and update the
	 * database.<BR>
	 * Primarily used when beginning a new cycle, and should otherwise never be
	 * called.
	 */
	 ...
	 * This method checks to see if the player has registered before and will
	...
	/**
	 * @param objectId
	 * @return the amount of ancient adena the specified player can claim, if
	 * any.
	 */
	...
	/**
	 * Used to add the specified player's seal stone contribution points to the
	 * current total for their cabal. Returns the point score the contribution
	 * was worth.<br>
	 * Each stone count <B>must be</B> broken down and specified by the stone's
	 * color.
	 *
	 ...
	 * Remember, the same number of points are <B>deducted from the rival
	...
	/**
	 * Used to initialize the seals for each cabal. (Used at startup or at
	 * beginning of a new cycle). This method should be called after
	...
	/**
	 * Only really used at the beginning of a new cycle, this method resets all
	 * seal-related data.
	 */
	...
	/**
	 * Calculates the ownership of the three Seals of the Seven Signs, based on
	 * various criterias.<BR>
	...
	/**
	 * The primary controller of period change of the Seven Signs system. This
	 * runs all related tasks depending on the period that is about to begin.
	 */
