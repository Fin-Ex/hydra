...
/**
 * This class handles the status of all Grand Bosses, and manages L2BossZone
 * zones.
 *
...
public class GrandBossManager {
	...
	protected GrandBossManager() {
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.warn("GrandBossManager: Could not load grandboss data: " + e.getMessage(), e);
		}
	}
	...
	/**
	 * Adds a L2GrandBossInstance to the list of bosses. Using this variant of
	 * addBoss, we can impose a npcId.
	 *
