...
public class PlayerAI extends PlayableAI {
	...
	/**
	 * Finalize the casting of a skill. Drop latest intention before the actual
	 * CAST.
	 */
	@Override
	 ...
	 * sending Server->Client packet MoveToLocation (broadcast)</li><BR>
	 * <BR>
	 */
	@Override
	...
	private void thinkCast() {
		...
		if (_skill.getTargetType() == ESkillTargetType.TARGET_GROUND && _actor instanceof Player) {
	...
	private void thinkPickUp() {
		...
		setIntention(CtrlIntention.IDLE);
		_actor.getPlayer().doPickupItem(target);
	}
	...
	private void thinkInteract() {
		...
		if (!(target instanceof StaticObject)) {
			_actor.getPlayer().doInteract((Creature) target);
		}
