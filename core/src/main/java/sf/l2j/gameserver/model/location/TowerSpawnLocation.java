...
/**
 * A datatype extending {@link SpawnLocation}, which handles a single Control
 * Tower spawn point and its parameters (such as guards npcId List), npcId to
 * spawn and upgrade level.
 */
