...
public class SiegeGuardAI extends AttackableAI {
	 ...
	 * EMPTY, IDLE will be change in ACTIVE</B></FONT>
	 *
	 ...
	 * to attack it</li>
	 * <li>If the actor can't attack, order to it to return to its home
	 * location</li>
	 * </ul>
	 */
	@Override
	 ...
	 * <li>Chose a target and order to attack it with magic skill or physical
	 * attack</li>
	 * </ul>
	 */
	@Override
	protected void thinkAttack() {
		...
		/**
		 * RETURN HOME<br>
		 * Check if the siege guard isn't too far ; if yes, then move him back
		 * to home.
		 */
	 ...
	 * <li>If the selected target is a defenser, drop from the list and pickup
	 * another.</li>
	 * </ul>
	 *
