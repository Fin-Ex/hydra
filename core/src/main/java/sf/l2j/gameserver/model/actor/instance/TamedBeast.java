 ...
 * <ul>
 * <li>feeding another beast to level 4 will vanish your actual tamed
 * beast.</li>
 * <li>running out of spices will vanish your actual tamed beast. There's a 1min
 * food check timer.</li>
 * <li>running out of the Beast Farm perimeter will vanish your tamed
 * beast.</li>
 * <li>no need to force attack it, it's a normal monster.</li>
 * </ul>
 * This class handles the running tasks (such as skills use and feed) of the
 * mob.
 */
public final class TamedBeast extends FeedableBeast {
	 ...
	 * Tamed mobs will heal/recharge or debuff the enemy according to their
	 * skills.
	 *
	 * @param attacker
	 */
	 ...
	 * <ul>
	 * <li>First, prepare the beast for casting, by abandoning other
	 * actions.</li>
