package sf.l2j.gameserver.model.group;
...
import sf.l2j.gameserver.model.entity.DimensionalRift;
...
import sf.l2j.gameserver.network.serverpackets.ExCloseMPCC;
import sf.l2j.gameserver.network.serverpackets.ExOpenMPCC;
import sf.l2j.gameserver.network.serverpackets.L2GameServerPacket;
import sf.l2j.gameserver.network.serverpackets.PartyMemberPosition;
import sf.l2j.gameserver.network.serverpackets.PartySmallWindowAdd;
import sf.l2j.gameserver.network.serverpackets.PartySmallWindowAll;
import sf.l2j.gameserver.network.serverpackets.PartySmallWindowDelete;
import sf.l2j.gameserver.network.serverpackets.PartySmallWindowDeleteAll;
...
public class Party extends AbstractGroup {
	 ...
	 * @see sf.l2j.gameserver.model.actor.instance.Player#isRequestExpired()
	 */
