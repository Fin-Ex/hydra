...
public class CommandChannel extends AbstractGroup {
	...
	/**
	 * <b>BEWARE : create a temporary List. Uses containsPlayer whenever
	 * possible.</b>
	 */
	@Override
	 ...
	 *
	 * @param party : the party to remove. Disband the channel if there was only
	 * 2 parties left.
	 * @return true if the party has been successfully removed from command
	 * channel.
	 */
