...
import sf.l2j.gameserver.instancemanager.DimensionalRiftManager.DimensionalRiftRoom;
...
public class DimensionalRift {
	...
	/**
	 * This method allows to jump from one room to another. It calculates the
	 * next roomId.
	 *
	 * @param player to teleport
	 * @param cantJumpToBossRoom if true, Anakazel room can't be choosen (case
	 * of manual teleport).
	 */
