package sf.l2j.gameserver.model.multisell;
...
/**
 * A datatype entry used to store multisell. A multisell is similar to a
 * buylist, but that system has been developped in addition.<br>
 * <br>
 * It holds a List of {@link Entry} and a Set of allowed npcIds for security
 * reasons (lazy initialization).
 */
