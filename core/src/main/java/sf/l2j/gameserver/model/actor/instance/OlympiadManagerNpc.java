...
import sf.l2j.gameserver.model.olympiad.CompetitionType;
...
import sf.l2j.gameserver.network.serverpackets.ExHeroList;
	...
	public void onBypassFeedback(Player player, String command) {
		if (command.startsWith("OlympiadNoble")) {
			...
			switch (val) {
				...
				default:
					_log.warn("Olympiad: Couldnt send packet for request: " + val);
					break;
			}
