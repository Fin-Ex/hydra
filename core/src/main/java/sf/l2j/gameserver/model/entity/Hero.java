...
public class Hero {
	...
	protected Hero() {
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.warn("Hero: Couldnt load heroes: " + e.getMessage(), e);
		}
	...
	public void loadMessage(int charId) {
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.warn("Hero: Couldnt load hero message for char_id: " + charId, e);
		}
	}
	...
	public void loadDiary(int charId) {
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.warn("Hero: Couldnt load hero diary for char_id: " + charId + ", " + e.getMessage(), e);
		}
	}
	...
	public void loadFights(int charId) {
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.warn("Hero: Couldnt load hero fights history for char_id: " + charId + ", " + e.getMessage(), e);
		}
	}
	...
	public void updateHeroes(boolean setDefault) {
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.warn("Hero: Couldnt update heroes: " + e.getMessage(), e);
		}
	}
	...
	public void setDiaryData(int charId, int action, int param) {
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.error("Hero: SQL exception while saving DiaryData.", e);
		}
	}
	...
	public void saveHeroMessage(int charId) {
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.error("Hero: SQL exception while saving HeroMessage.", e);
		}
	}
	...
	private static void deleteItemsInDb() {
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.warn("Hero: Couldn't delete items on db: " + e.getMessage(), e);
		}
	}
