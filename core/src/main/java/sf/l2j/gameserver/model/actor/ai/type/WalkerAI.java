...
import sf.l2j.gameserver.model.location.WalkerLocation;
import sf.l2j.gameserver.taskmanager.WalkerTaskManager;

/**
 * This AI is used by {@link Walker}s.<br>
 * <br>
 * We use basic functionalities of AI, notably {@link CtrlIntention} MOVE_TO and
 * onEvtArrived() to motion it.<br>
 * It retains a List of {@link WalkerLocation}s which, together, creates a
 * route, and we save the current node index to find the next WalkerLocation.
 * Once the path is complete, we return to index 0.<br>
 * <br>
 * It is associated to a global task named {@link WalkerTaskManager} to handle
 * individual WalkerLocation delays.
 */
