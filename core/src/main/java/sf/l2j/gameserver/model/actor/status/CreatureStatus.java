...
import sf.finex.model.regeneration.RegenTask;
...
public class CreatureStatus {
	...
	/**
	 * Add the object to the list of Creature that must be informed of HP/MP
	 * updates of this Creature.
	 *
	...
	/**
	 * Remove the object from the list of Creature that must be informed of
	 * HP/MP updates of this Creature.
	 *
	...
	/**
	 * Reduce the current HP of the Creature and launch the doDie Task if
	 * necessary.
	 *
	...
	public void startRegen(ERegenType... regens) {
		for (ERegenType regenType : regens) {
			...
			final RegenTask task = new RegenTask(_activeChar, regenType);
			switch (regenType) {
				case HP:
					if (hpTask == null) {
