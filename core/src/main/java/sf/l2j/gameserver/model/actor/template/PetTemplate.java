...
public final class PetTemplate extends NpcTemplate {
	...
	/**
	 * @return the auto feed limit, used for automatic use of food from pet's
	 * inventory (happens if % is reached). The value is under 1.0 format for
	 * easier management.
	 */
	...
	/**
	 * @return the hungry limit, used to lower stats (pet is weaker if %
	 * reached). The value is under 1.0 format for easier management.
	 */
	...
	/**
	 * @return the unsummon limit, used to check unsummon case (can't unsummon
	 * if % reached). The value is under 1.0 format for easier management.
	 */
	...
	/**
	 * @param level : The level of pet to retrieve. It can be either actual or
	 * any other level.
