...
import sf.l2j.gameserver.instancemanager.games.Lottery;
import sf.l2j.gameserver.model.L2Spawn;
import sf.l2j.gameserver.model.NewbieBuff;
...
import sf.l2j.gameserver.model.actor.instance.Gatekeeper;
import sf.l2j.gameserver.model.actor.instance.Merchant;
import sf.l2j.gameserver.model.actor.instance.WarehouseKeeper;
import sf.l2j.gameserver.model.actor.stat.NpcStat;
import sf.l2j.gameserver.model.actor.status.NpcStatus;
...
import sf.l2j.gameserver.model.actor.template.Race;
...
import sf.l2j.gameserver.network.serverpackets.ExShowVariationCancelWindow;
import sf.l2j.gameserver.network.serverpackets.ExShowVariationMakeWindow;
...
public class Npc extends Creature {
	...
	/**
	 * @return true if the server allows Random Animation, false if not or the
	 * AItype is a corpse.
	 */
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Call the Creature constructor to set the _template of the Creature
	 * (copy skills from template to object and link _calculators to
	...
	/**
	 * @return the generic Identifier of this L2Npc contained in the
	 * L2NpcTemplate.
	 */
	public int getNpcId() {
	...
	/**
	 * @return True if the L2Npc is agressive (ex : L2MonsterInstance in
	 * function of aggroRange).
	 */
	...
	/**
	 * @return the Identifier of the item in the left hand of this L2Npc
	...
	/**
	 * @return the Identifier of the item in the right hand of this L2Npc
	 * contained in the L2NpcTemplate.
	 */
	...
	/**
	 * Open a quest or chat window on client with the text of the L2Npc in
	...
	/**
	 * Collect quests in progress and possible quests and show proper quest
	 * window.
	 *
	...
	/**
	 * Open a quest window on client with the text of the L2Npc. Create the
	 * QuestState if not existing.
	 *
	 * @param player : the player that talk with the L2Npc.
	 * @param npc : the L2Npc instance.
	 ...
	 * <BR>
	 * <li>L2GuardInstance : Set the pathfile to data/html/guard/12006-1.htm
	...
	public void makeCPRecovery(Player player) {
		...
		if (player.reduceAdena("RestoreCP", 100, player.getCurrentFolkNPC(), true)) {
			setTarget(player);
			doCast(FrequentSkill.ARENA_CP_RECOVERY.getSkill(), false);
	...
	/**
	 * @return the Exp Reward of this L2Npc contained in the L2NpcTemplate
	 * (modified by RATE_XP).
	 */
	...
	/**
	 * @return the SP Reward of this L2Npc contained in the L2NpcTemplate
	 * (modified by RATE_SP).
	 */
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Create a DecayTask to remove the corpse of the L2Npc after 7
	 * seconds</li>
	...
	public boolean isFlying() {
		return getTemplate().isFlying();
	}

	public ETownType getTown() {
		return ETownType.getTownById(MapRegionTable.getTown(getX(), getY(), getZ()).getTownId());
	}
}
