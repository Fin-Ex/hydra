...
/**
 * A {@link StatsSet} which overrides methods to prevent doing useless database
 * operations if there is no changes since last edit (it uses an AtomicBoolean
 * to keep edition tracking).<br>
 * <br>
...
public abstract class AbstractMemo extends StatsSet {
	 ...
	 * @param expect
	 * @param update
	 * @return {@code true} if successful. {@code false} return indicates that
