package sf.l2j.gameserver.util;
...
public final class Broadcast {
	...
	/**
	 * Send a packet to all known players of the Creature that have the
	 * Character targetted.
	 *
	...
	/**
	 * Send a packet to all known players, in a specified radius, of the
	 * Creature.
	 *
	 * @param character : The character to make checks on.
	 * @param packet : The packet to send.
	...
	/**
	 * Send a packet to all known players of the Creature and to the specified
	 * Creature.
	 *
	 * @param character : The character to make checks on.
	 * @param packet : The packet to send.
	...
	/**
	 * Send a packet to all known players, in a specified radius, of the
	 * Creature and to the specified Creature.
	 *
	 * @param character : The character to make checks on.
	 * @param packet : The packet to send.
	 * @param radius : The given radius.
