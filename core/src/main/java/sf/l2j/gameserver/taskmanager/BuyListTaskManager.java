 ...
 * A timer is set, then on activation it restocks and releases it from the map.
 * Additionally, some SQL action is done.
 */
public final class BuyListTaskManager implements Runnable {
	...
	/**
	 * Test the timer : if already gone, reset the count without adding the
	 * {@link Product} to the task. A product can't be added twice.
	 *
	 * @param product : {@link Product} to be added.
