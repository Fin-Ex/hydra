...
/**
 * Updates position of moving {@link Creature} periodically. Task created as
 * separate Thread with MAX_PRIORITY.
 *
...
public final class MovementTaskManager extends Thread {
	...
	/**
	 * Add a {@link Creature} to MovementTask in order to update its location
	 * every MILLIS_PER_UPDATE ms.
	 *
