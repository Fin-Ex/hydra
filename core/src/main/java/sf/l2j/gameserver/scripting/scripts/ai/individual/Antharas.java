 ...
 * It uses the 29019 dummy id in order to register it (addBoss and statsSet),
 * but 3 different templates according the situation.
 */
public class Antharas extends L2AttackableAIScript {
	...
	/**
	 * Update Antharas informations depending about how much players joined the
	 * fight.<br>
	 * Used when server restarted and Antharas is fighting, or used while the
	 * cinematic occurs (after the 30min timer).
	 */
