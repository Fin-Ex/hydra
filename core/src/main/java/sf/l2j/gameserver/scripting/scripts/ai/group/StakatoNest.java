 ...
 * <ul>
 * <li>Cannibalistic Stakato Leader : try to eat a Follower, if any around, at
 * low HPs.</li>
 * <li>Female Spiked Stakato : when Male dies, summons 3 Spiked Stakato
 * Guards.</li>
 * <li>Male Spiked Stakato : when Female dies, transforms in stronger form.</li>
 * <li>Spiked Stakato Baby : when Spiked Stakato Nurse dies, her baby summons 3
 * Spiked Stakato Captains.</li>
 * <li>Spiked Stakato Nurse : when Spiked Stakato Baby dies, transforms in
 * stronger form.</li>
 * </ul>
 * As NCSoft implemented it on postIL, but skills exist since IL, I decided to
 * implemented that script to "honor" the idea (which is kinda funny).
 */
