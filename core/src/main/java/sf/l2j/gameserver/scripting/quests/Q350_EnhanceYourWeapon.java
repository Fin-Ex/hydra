...
import sf.l2j.gameserver.model.soulcrystal.LevelingInfo;
import sf.l2j.gameserver.model.soulcrystal.SoulCrystal;
...
public class Q350_EnhanceYourWeapon extends Quest {
	...
	/**
	 * Define the Soul Crystal and try to stage it. Checks for quest enabled,
	 * crystal(s) in inventory, required usage of crystal, mob's ability to
	 * level crystal and mob vs player level gap.
	 *
	 * @param player : The player to make checks on.
	 * @param mob : The mob to make checks on.
	 * @param npcInfo : The mob's leveling informations.
	 * @param chance : Input variable used to determine keep/stage/break of the
	 * crystal.
	 */
	...
	/**
	 * Remove the old crystal and add new one if stage, broken crystal if break.
	 * Send messages in both cases.
	 *
