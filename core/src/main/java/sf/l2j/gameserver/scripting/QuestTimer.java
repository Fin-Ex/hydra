...
public class QuestTimer {
	...
	/**
	 * public method to compare if this timer matches with the key attributes
	 * passed.
	 *
	 * @param quest : Quest instance to which the timer is attached
	 * @param name : Name of the timer
	 * @param npc : Npc instance attached to the desired timer (null if no npc
	 * attached)
	 * @param player : Player instance attached to the desired timer (null if no
	 * player attached)
	 * @return boolean
	 */
