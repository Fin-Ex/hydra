...
import sf.l2j.gameserver.network.serverpackets.SpecialCamera;
 ...
 * <ul>
 * <li>As a mad scientist, he thinks all are spies, and for so if you stand too
 * much longer near him you're considered as an "assassin from Black Anvil
 * Guild".</li>
 * <li>You can chat with him, but if you try too much he will become angry.</li>
 * <li>That adaptation sends a decent cinematic made with the different social
 * actions too.</li>
 * <li>The status of the RB is saved under GBs table, in order to retrieve the
 * state if server restarts.</li>
 * <li>The spawn of the different NPCs (Dr. Chaos / War golem) is handled by
 * that script aswell.</li>
 * </ul>
 */
