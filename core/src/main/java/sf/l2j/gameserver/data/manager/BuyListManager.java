...
import sf.l2j.gameserver.taskmanager.BuyListTaskManager;
...
/**
 * Loads and stores {@link NpcBuyList}, which is the most common way to
 * show/sell items, with multisell.<br>
 * <br>
 * NpcBuyList owns a list of {@link Product}. Each of them can have a count,
 * making the item acquisition impossible until the next restock timer (stored
 * as SQL data). The count timer is stored on a global task, called
