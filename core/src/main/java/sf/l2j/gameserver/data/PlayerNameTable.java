...
/**
 * This table caches players informations. It keeps a link between objectId and
 * a private DataHolder holding players name, account name and access level
 * informations.
 * <p>
 * It is notably used for any offline character check, such as friendlist,
 * existing character name, etc.
 * </p>
 */
public final class PlayerNameTable {
	...
	/**
	 * Update the player data. The informations must already exist. Used for
	 * name and access level edition.
	 *
	 * @param player : The player to update.
	 * @param onlyAccessLevel : If true, it will update the access level,
	 * otherwise, it will update the player name.
	 */
