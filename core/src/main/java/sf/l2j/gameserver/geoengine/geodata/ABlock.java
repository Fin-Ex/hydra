package sf.l2j.gameserver.geoengine.geodata;
...
public abstract class ABlock {
	 ...
	 *
	 * @return boolean : True, when block has geodata (Flat, Complex,
	 * Multilayer).
	 */
	...
	/**
	 * Returns the NSWE flag byte of cell, which is closest to given
	 * coordinates.
	 *
	 * @param geoX : Cell geodata X coordinate.
	 * @param geoY : Cell geodata Y coordinate.
	...
	/**
	 * Returns the NSWE flag byte of cell, which is first above given
	 * coordinates.
	 *
	 * @param geoX : Cell geodata X coordinate.
	 * @param geoY : Cell geodata Y coordinate.
	...
	/**
	 * Returns the NSWE flag byte of cell, which is first below given
	 * coordinates.
	 *
	 * @param geoX : Cell geodata X coordinate.
	 * @param geoY : Cell geodata Y coordinate.
	...
	/**
	 * Returns index to data of the cell, which is closes layer to given
	 * coordinates.
	 *
	 * @param geoX : Cell geodata X coordinate.
	 * @param geoY : Cell geodata Y coordinate.
	...
	/**
	 * Returns index to data of the cell, which is first layer above given
	 * coordinates.
	 *
	 * @param geoX : Cell geodata X coordinate.
	 * @param geoY : Cell geodata Y coordinate.
	 * @param worldZ : Cell world Z coordinate.
	 * @return {@code int} : Cell index. -1..when no layer available below given
	 * Z coordinate.
	 */
	...
	/**
	 * Returns index to data of the cell, which is first layer below given
	 * coordinates.
	 *
	 * @param geoX : Cell geodata X coordinate.
	 * @param geoY : Cell geodata Y coordinate.
	...
	/**
	 * Saves the block in L2D format to {@link BufferedOutputStream}. Used only
	 * for L2D geodata conversion.
	 *
