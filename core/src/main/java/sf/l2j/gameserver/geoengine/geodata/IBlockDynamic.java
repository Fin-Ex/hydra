...
public interface IBlockDynamic {
	...
	/**
	 * Adds {@link IGeoObject} to the {@link ABlock}. The block will update
	 * geodata according the object.
	 *
	...
	/**
	 * Removes {@link IGeoObject} from the {@link ABlock}. The block will update
	 * geodata according the object.
	 *
