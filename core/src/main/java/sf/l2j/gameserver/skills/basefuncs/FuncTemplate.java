...
import sf.finex.serializers.ConditionSerializer;
import sf.finex.serializers.LambdaSerializer;
import sf.finex.serializers.OrderSerializer;
import sf.finex.serializers.StatsSerializer;
...
public final class FuncTemplate {
	...
	public FuncTemplate(Condition pAttachCond, Condition pApplayCond, String pFunc, Stats pStat, int pOrder, Lambda pLambda) {
		...
		Class<?> func = null;
		try {
			func = Class.forName("sf.l2j.gameserver.skills.basefuncs.Func" + funcName);
