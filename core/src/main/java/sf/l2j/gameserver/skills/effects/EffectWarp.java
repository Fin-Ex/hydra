 ...
 * <li>Fly Course means the movement direction: imagine a compass above player's
 * head, making north player's heading. So if fly course is 180, player will go
 * backwards (good for blink, e.g.). By the way, if flyCourse = 360 or 0, player
