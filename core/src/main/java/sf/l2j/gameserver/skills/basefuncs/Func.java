...
/**
 * A Func object is a component of a Calculator created to manage and
 ...
 * When the calc method of a calculator is launched, each mathematics function
 * is called according to its priority <B>_order</B>.<br>
 * Indeed, Func with lowest priority order is executed first and Funcs with the
 * same order are executed in unspecified order.<br>
 * The result of the calculation is stored in the value property of an Env class
 * instance.
 */
public abstract class Func {

	/**
	 * Statistics, that is affected by this function (See
	 * Creature.CALCULATOR_XXX constants)
	 */
	 ...
	 * then bonus/penalty functions (multiply/divide) are applied, then
	 * functions that do more complex<br>
