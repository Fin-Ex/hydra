...
public class ArraysUtil {
	 ...
	 * @return {@code true} if the array contains the object, {@code false}
	 * otherwise.
	 */
	 ...
	 * @return {@code true} if the array contains the integer, {@code false}
	 * otherwise.
	 */
	 ...
	 * @return an array of the given type, holding informations of passed
	 * arrays.
	 */
