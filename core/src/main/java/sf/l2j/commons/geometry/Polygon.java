package sf.l2j.commons.geometry;
...
public class Polygon extends AShape {
	...
	/**
	 * Constructor of the {@link Polygon}. Creates a polygon, which consists of
	 * triangles using Kong's algorithm.
	 *
	 * @param id : Virtual ID of the polygon, used to separate constructor
	 * types.
	...
	/**
	 * Returns clockwise (cw) or counter-clockwise (ccw) orientation of the
	 * polygon.
	 *
	...
	/**
	 * This determines all concave vertices of the polygon and separate convex
	 * ones.
	 *
	 * @param points : List of all points.
	 ...
	 * @throws Exception : When coordinates are not aligned to form monotone
	 * polygon.
	 */
	...
	/**
	 * Returns true if the triangle formed by A, B, C points is an ear
	 * considering the polygon - thus if no other point is inside and it is
	 * convex.
	 *
	 * @param isCw : Polygon orientation (clockwise/counterclockwise).
	 * @param nonConvexPoints : List of all non-convex points.
	...
	/**
	 * Returns true when the point B is convex considered the actual polygon. A,
	 * B and C are three consecutive points of the polygon.
	 *
	 * @param isCw : Polygon orientation (clockwise/counterclockwise).
