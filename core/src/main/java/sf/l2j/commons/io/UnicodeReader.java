 ...
 * default is used if: BOM mark is not found and defaultEnc is NULL Usage
 * pattern: String defaultEnc = "ISO-8859-1"; // or NULL to use system default
 * FileInputStream fis = new FileInputStream(file); Reader in = new
