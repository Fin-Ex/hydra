 ...
 */
package sf.finex.model.items.table;

import java.util.ArrayList;
import java.util.List;
import lombok.Getter;
import lombok.extern.slf4j.Slf4j;
import sf.finex.DataParser;
import sf.finex.model.items.EquipData;
import sf.finex.model.items.ItemData;
import sf.finex.model.items.QuestData;
import sf.finex.model.items.UsableData;
