...
/**
 * A datatype extending {@link Location}, used as a unique node of a
 * pre-programmed route for Walker NPCs.<br>
 * <br>
 * Added to the x/y/z informations, you can also find delay (the time the Walker
 * NPC will stand on the point without moving), the String to broadcast (null if
 * none) and the running behavior.
 */
