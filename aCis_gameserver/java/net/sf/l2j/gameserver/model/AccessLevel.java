...
/**
 * A datatype used to retain access level informations, such as isGM() and
 * multiple allowed actions (experience gain, allow transactions/peace
...
public class AccessLevel {
	...
	/**
	 * @return true if the {@link AccessLevel} is allowed to attack in peace
	 * zone or not.
	 */
	...
	/**
	 * @return true if the {@link AccessLevel} is allowed to use fixed res or
	 * not.
	 */
	...
	/**
	 * @return true if the {@link AccessLevel} is allowed to perform
	 * transactions or not.
	 */
	...
	/**
	 * @return true if the {@link AccessLevel} is allowed to use AltG commands
	 * or not.
	 */
	...
	/**
	 * Set the child of a {@link AccessLevel} if not existing, then verify if
	 * this access level is associated to AccessLevel set as parameter.
	 *
	 * @param access : The AccessLevel to check.
	 * @return true if a child access level is equals to access, otherwise
	 * false.
	 */
