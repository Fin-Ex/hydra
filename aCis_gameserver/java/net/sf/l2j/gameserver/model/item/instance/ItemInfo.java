...
public class ItemInfo {
	...
	@Getter private int bodypart;
	@Getter private int enchant;
	@Getter private int augmentation;
	@Getter private int count;
	@Getter private int price;
	/**
	 * The custom ItemInstance types (used loto, race tickets)
	 */
	@Getter private int type1;
	@Getter private int type2;
	@Getter private int equipped;
	/**
	 * The action to do clientside (1=ADD, 2=MODIFY, 3=REMOVE)
	 */
	@Getter private ItemState change;
