...
/**
 * A datatype used only by Newbie Buffers NPC type. Those are beneficial magic
 * effects launched on newbie players in order to help them in their Lineage 2
 * adventures.<br>
 * <br>
...
public class NewbieBuff {
	...
	/**
	 * @return the lower level that the player must achieve in order to obtain
	 * this buff.
	 */
	...
	/**
	 * @return the upper level that the player mustn't exceed in order to obtain
	 * this buff.
	 */
