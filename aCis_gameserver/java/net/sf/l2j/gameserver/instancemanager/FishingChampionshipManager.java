...
public class FishingChampionshipManager {
	...
	protected static final Logger _log = LoggerFactory.getLogger(FishingChampionshipManager.class.getName());
	...
	private void restoreData() {
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.warn("FishingChampionshipManager: can't restore fishing championship info: " + e.getMessage(), e);
		}
	}
	...
	public void shutdown() {
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection()) {
			...
			_log.warn("FishingChampionshipManager: can't update infos: " + e.getMessage(), e);
		}
	}
