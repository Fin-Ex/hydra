...
public class PetInfo extends L2GameServerPacket {
	...
	protected final void writeImpl() {
		...
		writeC(_summon.getPlayer() != null ? 1 : 0); // when pet is dead and player exit game, pet doesn't show master name
		...
		writeD(1);
		writeD(_summon.getPlayer() != null ? _summon.getPlayer().getPvpFlag() : 0); // 0 = white,2= purple
		writeD(_summon.getPlayer() != null ? _summon.getPlayer().getKarma() : 0); // karma
