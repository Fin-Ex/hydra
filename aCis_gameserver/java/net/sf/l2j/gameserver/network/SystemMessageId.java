...
public final class SystemMessageId {
	...
	/**
	 * ID: 233<br>
	 * Message: The Academy/Royal Guard/Order of Knights is full and cannot
	...
	/**
	 * ID: 404<br>
	 * Message: Your S1 level is too low to register this recipe.
	 */
	public static final SystemMessageId S1_LVL_TOO_LOW_TO_REGISTER;
	...
	/**
	 * ID: 572<br>
	 * Message: Do you accept $s1's party invitation? (Item Distribution:
	 * Finders Keepers.)
	 */
	...
	/**
	 * ID: 968<br>
	 * Message: Do you accept $s1's party invitation? (Item Distribution: By
	 * Turn.)
	 */
	 ...
	 * less than level three, and or they do not have enough members.
	 */
	...
	/**
	 * ID: 1689<br>
	 * Message: You have already joined the waiting list for a class specific
	 * match.
	 */
	...
	/**
	 * ID: 1690<br>
	 * Message: You have already joined the waiting list for a non-class
	 * specific match.
	 */
	...
	/**
	 * ID: 1691<br>
	 * Message: You can't join a Grand Olympiad Game match with that much stuff
	 * on you! Reduce your weight to below 80 percent full and request to join
	 * again!
	 */
	...
	/**
	 * ID: 1692<br>
	 * Message: You have changed from your main class to a subclass and
	 * therefore are removed from the Grand Olympiad Games waiting list.
	 */
	...
	/**
	 * ID: 2027<br>
	 * Message: $s1 cannot duel because $s1 is currently riding a boat or
	 * strider.
	 */
	...
	/**
	 * ID: 2029<br>
	 * Message: $s1 is currently teleporting and cannot participate in the
	 * Olympiad.
	 */
	...
	/**
	 * ID: 2160<br>
	 * Message: Do you realy want to learn $s1 by loosing 1 LP?
	 */
	public static final SystemMessageId DO_YOU_REALY_WANT_TO_LEARN_S1_TALENT;

	/**
	 * ID: 2161<br>
	 * Message: Not enough lineage points.
	 */
	public static final SystemMessageId NOT_ENOUGH_LINEAGE_POINTS;

	/**
	 * ID: 2162<br>
	 * Message: Your level is too low.
	 */
	public static final SystemMessageId YOUR_LEVEL_IS_TOO_LOW;

	/**
	 * ID: 2163<br>
	 * Message: $s1 LP (Lineage Points) was consumed.
	 */
	public static final SystemMessageId S1_LP_WAS_CONSUMED;

	/**
	 * ID: 2164<br>
	 * Message: $s1 already learned!
	 */
	public static final SystemMessageId S1_ALREADY_LEARNED;

	/**
	 * ID: 2165<br>
	 * Message: Parry attack!
	 */
	public static final SystemMessageId PARRY_ATTACK;

	/**
	 * ID: 2166<br>
	 * Message: Parry attack!
	 */
	public static final SystemMessageId S1_SKILL_COOLDOWN_WAS_REMOVED;

	/**
	 * ID: 2167<br>
	 * Message: Combo bonus increased to $s1% (EXP/SP bonus reward)!
	 */
	public static final SystemMessageId COMBO_BONUS_INCREASE_TO_S1;

	/**
	 * ID: 2168<br>
	 * Message: Maintaining a combination of hunting will allow you to increase
	 * your gaining EXP/SP while hunting.
	 */
	public static final SystemMessageId COMBO_CONTINUE_1;

	/**
	 * ID: 2169<br>
	 * Message: Each combination allows you to receive an additional bonus to
	 * the EXP/SP.
	 */
	public static final SystemMessageId COMBO_CONTINUE_2;

	/**
	 * ID: 2170<br>
	 * Message: The combination is held for 30 seconds. Do not waste time! To
	 * Hunt!
	 */
	public static final SystemMessageId COMBO_CONTINUE_3;

	/**
	 * ID: 2171<br>
	 * Message: First you need learn $s1 before you can learn $s2.
	 */
	public static final SystemMessageId YOU_MUST_LEARN_S1_BEFORE_LEARN_S2;

	/**
	 * ID: 2172<br>
	 * Message: Do you want reset all your masteries for $s1 $s2?
	 */
	public static final SystemMessageId DO_YOU_WANT_TO_RESET_ALL_YOUR_MASTERIES_FOR_S1_S2;

	/**
	 * ID: 2173<br>
	 * Message: Nothing to reset.
	 */
	public static final SystemMessageId NOTHING_TO_RESET;

	/**
	 * ID: 2174<br>
	 * Message: Mastery Tree was reseted. $s1 LP was returned.
	 */
	public static final SystemMessageId MASTERY_TREE_WAS_RESETED_AND_S1_LP_WAS_RETURNED;

	/**
	 * ID: 2175<br>
	 * Message: Do you want reset all your masteries?
	 */
	public static final SystemMessageId DO_YOU_WANT_TO_RESET_ALL_YOUR_MASTERIES;

	/**
	 * ID: 2176<br>
	 * Message: $s1 was reinforcement by $s2
	 */
	public static final SystemMessageId S1_WAS_REINFORCEMENT_BY_S2;

	/**
	 * ID: 2177<br>
	 * Message: Rhythm feeling: $s1
	 */
	public static final SystemMessageId RHYTHM_FEEL_IS_S1;

	/**
	 * ID: 2178<br>
	 * Message: Quest $s1 was accepted.
	 */
	public static final SystemMessageId QUEST_S1_WAS_ACCEPTED;

	/**
	 * ID: 2179<br>
	 * Message: Quest $s1 was canceled and returned to quest town board.
	 */
	public static final SystemMessageId QUEST_S1_WAS_CANCELED;

	/**
	 * ID: 2180<br>
	 * Message: $s1 already takened by another person.
	 */
	public static final SystemMessageId S1_ALREADY_TAKENED_BY_ANOTHER_PERSON;

	/**
	 * ID: 2181<br>
	 * Message: Your level is too low for that operation.
	 */
	public static final SystemMessageId YOUR_LEVEL_TO_LOW;

	/**
	 * ID: 2182<br>
	 * Message: Your level is too high for that operation.
	 */
	public static final SystemMessageId YOUR_LEVEL_TO_HIGH;

	/**
	 * ID: 2183<br>
	 * Message: You has a penalty for canceling the quest. Try again later.
	 */
	public static final SystemMessageId YOU_HAVE_A_PENALTY_FOR_TAKE_A_QUEST;

	/**
	 * ID: 2184<br>
	 * Message: You dont have a quest for canceling.
	 */
	...
	static {
		...
		S1_LVL_TOO_LOW_TO_REGISTER = new SystemMessageId(404);
		...
		DO_YOU_REALY_WANT_TO_LEARN_S1_TALENT = new SystemMessageId(2160);
		NOT_ENOUGH_LINEAGE_POINTS = new SystemMessageId(2161);
		YOUR_LEVEL_IS_TOO_LOW = new SystemMessageId(2162);
		S1_LP_WAS_CONSUMED = new SystemMessageId(2163);
		S1_ALREADY_LEARNED = new SystemMessageId(2164);
		PARRY_ATTACK = new SystemMessageId(2165);
		S1_SKILL_COOLDOWN_WAS_REMOVED = new SystemMessageId(2166);
		COMBO_BONUS_INCREASE_TO_S1 = new SystemMessageId(2167);
		COMBO_CONTINUE_1 = new SystemMessageId(2168);
		COMBO_CONTINUE_2 = new SystemMessageId(2169);
		COMBO_CONTINUE_3 = new SystemMessageId(2170);
		YOU_MUST_LEARN_S1_BEFORE_LEARN_S2 = new SystemMessageId(2171);
		DO_YOU_WANT_TO_RESET_ALL_YOUR_MASTERIES_FOR_S1_S2 = new SystemMessageId(2172);
		NOTHING_TO_RESET = new SystemMessageId(2173);
		MASTERY_TREE_WAS_RESETED_AND_S1_LP_WAS_RETURNED = new SystemMessageId(2174);
		DO_YOU_WANT_TO_RESET_ALL_YOUR_MASTERIES = new SystemMessageId(2175);
		S1_WAS_REINFORCEMENT_BY_S2 = new SystemMessageId(2176);
		RHYTHM_FEEL_IS_S1 = new SystemMessageId(2177);
		QUEST_S1_WAS_ACCEPTED = new SystemMessageId(2178);
		QUEST_S1_WAS_CANCELED = new SystemMessageId(2179);
		S1_ALREADY_TAKENED_BY_ANOTHER_PERSON = new SystemMessageId(2180);
		YOUR_LEVEL_TO_LOW = new SystemMessageId(2181);
