...
public final class SystemMessageId
{
	...
	/**
	 * ID: 2168<br>
	 * Message: Maintaining a combination of hunting will allow you to increase your gaining EXP/SP while hunting.
	 */
	public static final SystemMessageId COMBO_CONTINUE_1;
	
	/**
	 * ID: 2169<br>
	 * Message: Each combination allows you to receive an additional bonus to the EXP/SP.
	 */
	public static final SystemMessageId COMBO_CONTINUE_2;
	
	/**
	 * ID: 2170<br>
	 * Message: The combination is held for 30 seconds. Do not waste time! To Hunt!
	 */
