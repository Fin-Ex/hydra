...
public final class Env {
	...
	public Env(int shield, boolean soulShot, boolean spiritShot, boolean blessedSpiritShot) {
		_shield = shield;
		_soulShot = soulShot;
	...
	public Player getPlayer() {
		return _character == null ? null : _character.getPlayer();
	}
