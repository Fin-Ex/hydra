...
public final class Formulas
{
	...
	/**
	 * Increase damage depends from target distance to caster. Closer distance get more damage, far distance - less.
	...
	/**
	 * Calculates modified effect apply-time which depends from current target <b>defense</b> variable.
	 * @param caster
	 * @param target
	 * @param skill
	 * @param type
	 ...
	 * <font color="ff0000"><b>Works only for {@code isProjectile()} skills!</b></font>
