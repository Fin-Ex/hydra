...
public final class DocumentSkill extends DocumentBase {
	...
	private void makeSkills() {
		...
		for (int i = 0; i < _currentSkill.sets.length; i++) {
			try {
				_currentSkill.currentSkills.add(i, _currentSkill.sets[i].getEnum("skillType", ESkillType.class).makeSkill(_currentSkill.sets[i]));
				count++;
			} catch (Exception e) {
				log.error("Skill id=" + _currentSkill.sets[i].getEnum("skillType", ESkillType.class).makeSkill(_currentSkill.sets[i]).getId() + "level" + _currentSkill.sets[i].getEnum("skillType", ESkillType.class).makeSkill(_currentSkill.sets[i]).getLevel(), e);
			}
		}
		int _count = count;
		for (int i = 0; i < _currentSkill.enchsets1.length; i++) {
			try {
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets1[i].getEnum("skillType", ESkillType.class).makeSkill(_currentSkill.enchsets1[i]));
				count++;
			} catch (Exception e) {
				log.error("Skill id=" + _currentSkill.enchsets1[i].getEnum("skillType", ESkillType.class).makeSkill(_currentSkill.enchsets1[i]).getId() + " level=" + _currentSkill.enchsets1[i].getEnum("skillType", ESkillType.class).makeSkill(_currentSkill.enchsets1[i]).getLevel(), e);
			}
		}
		_count = count;
		for (int i = 0; i < _currentSkill.enchsets2.length; i++) {
			try {
				_currentSkill.currentSkills.add(_count + i, _currentSkill.enchsets2[i].getEnum("skillType", ESkillType.class).makeSkill(_currentSkill.enchsets2[i]));
				count++;
			} catch (Exception e) {
				log.error("Skill id=" + _currentSkill.enchsets2[i].getEnum("skillType", ESkillType.class).makeSkill(_currentSkill.enchsets2[i]).getId() + " level=" + _currentSkill.enchsets2[i].getEnum("skillType", ESkillType.class).makeSkill(_currentSkill.enchsets2[i]).getLevel(), e);
			}
		}
	}
}
