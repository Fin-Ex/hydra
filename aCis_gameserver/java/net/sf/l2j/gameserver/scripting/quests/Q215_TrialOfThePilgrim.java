...
public class Q215_TrialOfThePilgrim extends Quest {
	...
	public String onTalk(Npc npc, Player player) {
		...
		switch (st.getState()) {
			case STATE_CREATED:
				if (player.getClassId() != ClassId.Cleric && player.getClassId() != ClassId.ElvenOracle && player.getClassId() != ClassId.ShillienOracle && player.getClassId() != ClassId.OrcShaman) {
