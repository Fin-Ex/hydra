...
public class Q211_TrialOfTheChallenger extends Quest
{
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		{
			case STATE_CREATED:
				if (player.getClassId() != ClassId.Warrior && player.getClassId() != ClassId.ElvenKnight && player.getClassId() != ClassId.PalusKnight && player.getClassId() != ClassId.OrcRaider && player.getClassId() != ClassId.Monk)
