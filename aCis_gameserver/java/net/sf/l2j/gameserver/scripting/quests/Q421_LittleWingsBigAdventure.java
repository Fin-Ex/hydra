...
/**
 * iCond is an internal variable, used because cond isn't developped on that
 * quest (only 3 states) :
 * <ul>
 * <li>1-3 leads initial mimyu behavior ;</li>
 * <li>used for leaves support as mask : 4, 8, 16 or 32 = 60 overall ;</li>
 * <li>63 becomes the "marker" to get back to mimyu (60 + 3), meaning you hitted
 * the 4 trees ;</li>
...
public class Q421_LittleWingsBigAdventure extends Quest {
	...
	public String onAttack(Npc npc, Player attacker, int damage, boolean isPet, L2Skill skill) {
		...
		if (isPet && attacker.getActiveSummon().getControlItemId() == st.getInt("summonOid")) {
	...
	public String onKill(Npc npc, Player killer, boolean isPet) {
		final Creature originalKiller = isPet ? killer.getActiveSummon() : killer;
