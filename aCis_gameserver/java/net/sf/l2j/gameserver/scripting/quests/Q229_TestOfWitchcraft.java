...
public class Q229_TestOfWitchcraft extends Quest
{
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		{
			case STATE_CREATED:
				if (player.getClassId() != ClassId.Knight && player.getClassId() != ClassId.HumanWizard && player.getClassId() != ClassId.PalusKnight)
					htmltext = "30630-01.htm";
				else if (player.getLevel() < 39)
					htmltext = "30630-02.htm";
				else
					htmltext = (player.getClassId() == ClassId.HumanWizard) ? "30630-03.htm" : "30630-05.htm";
				break;
