...
public final class SelectorConfig {
	...
	/**
	 * Used to enable/disable TCP_NODELAY which disable/enable Nagle's
	 * algorithm.<BR>
	 * <BR>
	 * Nagle's algorithm try to conserve bandwidth by minimizing the number of
	 ...
	 * (that is enable TCP_NODELAY). Data will be sent earlier, at the cost of
	 * an increase in bandwidth consumption. The Nagle's algorithm is described
	 * in RFC 896.<BR>
	 * <BR>
	 * Summary, data will be sent earlier, thus lowering the ping, at the cost
	 * of a small increase in bandwidth consumption.
	 */
