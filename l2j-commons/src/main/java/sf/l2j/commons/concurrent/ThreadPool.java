package sf.l2j.commons.concurrent;
...
/**
 * This class handles thread pooling system. It relies on two ThreadPoolExecutor
 * arrays, which poolers number is generated using config.
 * <p>
...
public final class ThreadPool {
	...
	/**
	 * Init the different pools, based on Config. It is launched only once, on
	 * Gameserver instance.
	 */
	public static void init() {
		...
		for (int i = 0; i < poolCount; i++) {
			_scheduledPools[i] = new ScheduledThreadPoolExecutor(2);
		}
