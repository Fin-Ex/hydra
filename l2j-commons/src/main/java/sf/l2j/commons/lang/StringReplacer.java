package sf.l2j.commons.lang;

/**
 * This class is used as a counter to replaceAll. It avoids to generate Strings
 * and is roughly 50% faster than string method format().
 *
 * @author xblx
 */
public final class StringReplacer {
	...
	/**
	 * Replace all delimiters '{}' by the String representation of any objects.
	 * Important things to note:
	 * <ul>
	 * <li>If there isn't enough parameters, then the leftover isn't
	 * processed.</li>
	 * <li>If there is too much parameters, the loop breaks when it doesn't find
	 * anything to replace.</li>
